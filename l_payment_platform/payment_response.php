...
// $data = $_REQUEST['MerchantTransactionID'];
$transid  = isset($_GET['MerchantTransactionID']) ? $_GET['MerchantTransactionID'] : '';


// $_REQUEST['username'] = $_SESSION['username_sess']; //$_SESSION['username'];
